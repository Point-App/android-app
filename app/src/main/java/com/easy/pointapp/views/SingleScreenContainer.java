...
public class SingleScreenContainer extends FrameLayout implements Container {
    ...
    private void hideKeyboard() {
        ...
        if (view != null) {
            InputMethodManager inputManager = (InputMethodManager) ((Activity)getContext()).getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    @Override public void showPosts() {
    ...
    @Override public void showComments(Post post) {
        if (this.getChildCount()!=0) {
            removeViewAt(0);
    ...
    @Override public void showCreateComment(Post post) {
        if (this.getChildCount()!=0) {
            removeViewAt(0);
    ...
    @Override public void showCreatePost()
    {
        ...
        else
        {
            ...
            showCreateComment(addCommentView.post);
        }

    }
    @Override public void showFavorites(){
        if (this.getChildCount()!=0) {
            removeViewAt(0);
